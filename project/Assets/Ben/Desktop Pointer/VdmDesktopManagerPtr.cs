...
public class VdmDesktopManagerPtr : MonoBehaviour
{

    public static VdmDesktopManagerPtr Instance;
    ...
    private List<VdmDesktopPtr> Monitors = new List<VdmDesktopPtr>();
    ...
    IEnumerator Start()
    {
        ...
        for (int s = 0; s < nScreen; s++)
        {
            ...
            VdmDesktopPtr desk = monitor.AddComponent<VdmDesktopPtr>();
            desk.Screen = s;
    ...
    void Update()
    {
        ...
        foreach (VdmDesktopPtr monitor in Monitors)
        {
            monitor.HideLine();
    ...
    public void Connect(VdmDesktopPtr winDesk)
    {
    ...
    public void Disconnect(VdmDesktopPtr winDesk)
    {
    ...
    private void ReInit()
    {
        ...
        foreach (VdmDesktopPtr winDesk in Monitors)
        {
