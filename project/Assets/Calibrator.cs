...
public class Calibrator : MonoBehaviour {
	...
	void triggerClicked(object sender, ClickedEventArgs e)
    {
		if(currentStage == CalibrationStage.DesignateController) {
		...
		} else if (currentStage == CalibrationStage.CalibrateChair) { //Chair calibration stage
			if(chairCalibrationPoints.Count <= 4) { //Adds the calibration point local to the chair controller
			...
			if(chairCalibrationPoints.Count == 4) { //When the calibrator has 4 points
				//math stuff
