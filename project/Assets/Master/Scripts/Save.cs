...
public class Save {
    ...
    public Save(string name)
    {
        this.name = name;
        currentRoomIndex = 0;
        rooms = new Room[]{new Room("CRUD Room", 5, Color.black), new Room("Base Room", 1, Color.yellow), new Room("Secondary Room", 2, Color.green), new Room("Tree House", 4, Color.cyan)};
    }
